...
### Setup
- This project requires SQL Server (My SQL), Power BI Desktop
...
### Dashboard
- [Download the file](https://github.com/gopalsikarwar/Sales-Analysis-with-SQL/blob/main/Sales%20Report.pbix) and open in Power BI Desktop for interactive viewing.
- [See a screenshot](https://github.com/gopalsikarwar/Sales-Analysis-with-SQL/blob/main/Sales%20Report.pdf) of the Dashboard in pdf.
